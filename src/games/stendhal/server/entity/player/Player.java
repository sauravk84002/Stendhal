...
public class Player extends DressedEntity implements UseListener {
	...
	public void TeleportToTour() {
		this.teleport("0_nalwor_city", 100, 30, null, this);
	...
	public void tour(){
		...
		int nx = this.getX();
		int ny = this.getY();
		double  distance = Math.sqrt(Math.pow((nx-x), 2)+Math.pow((ny-y), 2));
		if(distance >100) {
			this.setInvisible(false);
			this.teleport("0_ados_city",30,30,null,this); 
		}
