...
public class PotionsDealerNPC implements ZoneConfigurator {
	...
	private void initShop(final StendhalRPZone zone) {
		...
		zone.add(sign);
		final String sellerShopName = "atlantisRentingShop";
		final ShopSign sign1 = new ShopSign(sellerShopName, "Atlantis Renting Shop", "you will able to unlock this shop after you reached LV20", true);
		sign1.setEntityClass("blackboard");
		sign1.setPosition(7, 7);
		zone.add(sign1);
