...
public class MeetZynn extends AbstractQuest {
	...
	private void step_1() {
		...
		// added IncreaseXPAction after relevant dialogues to increase xp
		npc
				.addReply(
						"history",
						"At present, there are two significant powers on Faiumoni; the Deniran Empire, and the dark legions of Blordrough. Blordrough has recently conquered the south of the island, seizing several steel mines and a large gold mine. At present, Deniran still controls the central and northern parts of Faiumoni, including several gold and mithril mines.", new IncreaseXPAction(10));
		...
		npc
				.addReply(
						"Nalwor",
						"Nalwor is an ancient elven city, built deep inside the forest to the southeast of us long before humans ever arrived on this island. Elves don't like mixing with other races, but we're given to understand that Nalwor was built to help defend their capital city of Teruykeh against an evil force.", new IncreaseXPAction(10));
	...
	public List<String> getHistory(final Player player) {
		...
		temp.add("I talked with Zynn, a very pleasant person. He wants to help me with how to buy weapon so I should ask him about that help.");
		if (isCompleted(player)) {
			temp.add("I listened to his really useful information about how to deal with traders like Xin Blanca, a guy in Semos tavern.");
		}
		return temp;
	}
