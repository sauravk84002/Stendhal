...
public class BuyerNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		...
		npc.initHP(100);
		zone.add(npc);
		final String sellerShopName = "vondarentingshop";
		final ShopSign sign1 = new ShopSign(sellerShopName, "Vonda Renting shop",  " you can hire this shop from Vonda", true);
		sign1.setDescription("This shop can be hired after you reached LV50");
		sign1.setEntityClass("blackboard");
		sign1.setPosition(10, 10);
		zone.add(sign1);
