...
public class PotionsDealerNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		...
		final ShopSign sign2 = new ShopSign(sellerShopName, "Wanda Potions Shop", npc.getName() + " sells the following items", true);
		sign2.setEntityClass("blackboard");
		sign2.setPosition(5, 6);
		zone.add(sign2);
		
		final String buyerShopName = "deniranpotionssell";
		final ShopSign sign1 = new ShopSign(buyerShopName, "Wanda Potions Shop", npc.getName() + " sells your items", true);
		sign1.setEntityClass("blackboard");
		sign1.setPosition(10, 6);
		zone.add(sign1);
	}
}
